...
<div class="footer-top">
  <div class="container">
    ...
    <div class="footer-brand">
      ...
      <a href="#" class="logo">
        <img src="./assets/images/logarxa1.png" alt="Logo arxatec">
      </a>

      <p class="section-text">
        ArxaTEC está dedicada a proporcionar asesoramiento legal en línea accesible y confiable para ciudadanos.
      </p>
      ...
      <ul class="contact-list">
        ...
        <li>
          <a href="mailto:contact@homeverse.com" class="contact-link">
            ...
            <span>contacto@xpertice.pe</span>
          </a>
        </li>
...
<div class="footer-bottom">
  <div class="container">
    ...
    <p class="copyright">
      &copy; 2024 <a href="#">ArxaTEC</a>. All Rights Reserved
    </p>
