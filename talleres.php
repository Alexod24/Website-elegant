                  ...
                  <div class="title-box text-center">
					...
					<div class=" col-md-12 text-center">
						...
						<ul class="filtering">
							...
							<li class="filter" data-filter="fashion">Codigo Penal</li>
							<li class="filter" data-filter="event">Problemas familiares</li>
							<li class="filter" data-filter="wedding">Pensiones</li>
							<li class="filter" data-filter="corporate">Divorcio</li>
						</ul>
					</div>
